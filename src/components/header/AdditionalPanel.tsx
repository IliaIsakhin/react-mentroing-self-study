...
import { EnumSortBy } from '../DTO/Enums/Enums'

export default class AdditionalPanel extends React.Component<{ moviesCounter: number, handleChangeSorting: Function, params: ParamsDTO }, {}> {
    constructor(props) {
        super(props)
